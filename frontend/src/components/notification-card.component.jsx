...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    const handleDelete = (comment_id, type, target) => {
        ...
        .then(() => {
            ...
            setNotifications({ ...Notifications, results, totalDocs: totalDocs-1, deleteDocument: notifications.deleteDocument + 1 })
        })
        .catch(err => {
            console.log(err);
        })
    ...
    return (
        <div className= {"p-6 border-grey border-l-black " + ( !seen ? "border-l-2" : "") } >
            ...
            {
                type != 'like' && comment ?
                <p className="ml-14 pl-5 font-galasio text-xl my-5">{comment.comment}</p> 
                : "" 
            }
...

            {
                ...
                <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                    ...
                    <p className="ml-14 font-galasio text-xl my-2">{reply.comment}</p>
