...
const BlogInteraction = () =>{
    ...
    return(
        ...
        <div className="flex gap-3 items-center">
            ...
            <p className="text-xl text-dark-grey">{ total_likes }
            </p>
            ...
            <p className="text-xl text-dark-grey">{ total_comments }
            </p>
        ...
        <div className="flex gap-6 items-center">
            ...
            ${title}&url=${location.href}`}> <i className="fi fi-brands-twitter text-xl 
            hover:text-twitter"></i></Link>
        </div>
        </div>
        <hr className="border-grey my-2" />
        </>
